...
_ = builder
    ...
    {
        context.EnvironmentVariables["AWS_VIRTUAL_HOSTING"] = bool.FalseString;
        context.EnvironmentVariables["CPL_AWS_CREDENTIALS_FILE"] = context.EnvironmentVariables[Amazon.Runtime.CredentialManagement.SharedCredentialsFile.SharedCredentialsFileEnvVar];
        context.EnvironmentVariables["AWS_S3_ENDPOINT"] = context.EnvironmentVariables["AWS_ENDPOINT_URL_S3"];
    })
    .WithReference(config)
